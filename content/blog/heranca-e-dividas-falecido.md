...
1. Levanta-se tudo o que a pessoa deixou de bens (casas, carros, dinheiro em conta). Isso forma o "Espólio".
2. Levanta-se todas as dívidas.
3. As dívidas são pagas usando os bens do Espólio.
4. O que sobrar (se sobrar) é dividido entre os herdeiros.
...
Neste caso, os herdeiros fazem um procedimento chamado *Inventário Negativo*, apenas para comprovar legalmente que não há bens a partilhar, encerrando qualquer possibilidade de cobrança futura por parte dos credores.