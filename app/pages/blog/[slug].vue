...
<template>
  <main class="bg-charcoal min-h-screen pt-32 pb-24">
    ...
    <article v-if="article" class="container mx-auto px-6 max-w-3xl">
      ...
      <NuxtLink to="/#blog" class="inline-flex items-center gap-2 text-[10px] font-bold tracking-[0.3em] uppercase text-white/40 hover:text-gold transition-colors mb-12">
    ...
    <div v-else class="container mx-auto px-6 max-w-3xl text-center py-20 flex flex-col items-center">
      ...
      <NuxtLink to="/#blog" class="px-8 py-3 bg-white text-charcoal font-bold text-[10px] uppercase tracking-widest hover:bg-gold transition-colors">
        Voltar para o site
      </NuxtLink>
    </div>
